...
public class Paging2 implements Serializable {
	...
	public long currentComPage; // 현재 댓글 페이지
	

	public Paging2(long totalPost, int numOfPagePerBlock, int numOfPostPerPage, long currentComPage) {
		this.totalPost = totalPost;
		this.numOfPagePerBlock = numOfPagePerBlock;
		this.numOfPostPerPage = numOfPostPerPage;
		this.currentComPage = currentComPage;
	...
	public long getCurrentComPage() {
		return currentComPage;
	}
	...
	public void setCurrentComPage(long currentComPage) {
		this.currentComPage = currentComPage;
	}
	...
	public void pagingProc() {
		...
		// 현재 블럭 = ((5 -1) / 10 ) + 1 = 1.4
		currentBlock = ((currentComPage - 1) / numOfPagePerBlock) + 1;
		...
		startPost = (currentComPage - 1) * numOfPostPerPage + 1;
		...
		// 게시물 시작 번호 = 36 - ((2 -1) * 10) = 
		postNumber = totalPost - (currentComPage - 1) * numOfPostPerPage;
	}
}